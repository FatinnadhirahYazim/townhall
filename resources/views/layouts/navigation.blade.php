<nav x-data="{ open: false }" class="bg-[#fcfcf9] border-b-[3px] border-black sticky top-0 z-50">
        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="text-2xl font-black font-outfit uppercase tracking-tight">
                        TownHall
                    </a>
                </div>
